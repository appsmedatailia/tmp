...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_ENTREPRISE: 'entreprise/PARTIAL_UPDATE_ENTREPRISE',
  DELETE_ENTREPRISE: 'entreprise/DELETE_ENTREPRISE',
  SET_BLOB: 'entreprise/SET_BLOB',
...
export default (state: EntrepriseState = initialState, action): EntrepriseState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_ENTREPRISE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_ENTREPRISE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_ENTREPRISE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IEntreprise> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_ENTREPRISE,
