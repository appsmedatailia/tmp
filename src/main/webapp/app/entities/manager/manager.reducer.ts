...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_MANAGER: 'manager/PARTIAL_UPDATE_MANAGER',
...
export default (state: ManagerState = initialState, action): ManagerState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_MANAGER):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_MANAGER):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_MANAGER):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IManager> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_MANAGER,
