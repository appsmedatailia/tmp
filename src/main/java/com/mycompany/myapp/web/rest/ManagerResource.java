...
public class ManagerResource {
    ...
    public ResponseEntity<Manager> updateManager(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, manager.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Manager> partialUpdateManager(
        ...
        Optional<Manager> result = managerRepository
            ...
            .map(
                existingManager -> {
                    if (manager.getCivility() != null) {
                        existingManager.setCivility(manager.getCivility());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, manager.getId())
        );
    }
